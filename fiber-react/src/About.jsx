...
import about_img01 from '/src/assets/img/images/about_img01.jpg'
import about_img02 from '/src/assets/img/images/about_img02.jpg'
import progress_img from '/src/assets/img/images/progress_img.png'
import cta_bg from '/src/assets/img/bg/cta_bg.jpg'
  ...
  return (
    <>
       <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img-wrap">
                                <img src={about_img01} alt="Best Internet Connection in Chennai" title="Best Broadband Connection in Chennai" />
                                <img src={about_img02} class="main-img" alt="Best Broadband plans in Chennai" title="Best fibernet plans in Chennai"/>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="section-title mb-30">
                                <h2 class="title">We Provide Best Internet Connection in Chennai</h2>
                            </div>
                            <div class="about-content">
                                <p>Yes! You'll be able to use your Mobile Home Internet to connect your computer, phone, and numerous other devices. Gauge your students’ skill level with the initial test and follow their progress.</p>
                                <ul class="about-list">
            ...
            <section class="counter-area pt-115 pb-65">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-item">
                                <h2 class="title"><span class="odometer" data-count="5"></span>k+</h2>
                                <p>Happy Customers</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-item">
                                <h2 class="title"><span class="odometer" data-count="15"></span>+</h2>
            ...
            {/* cta-area */}
            <section class="cta-area cta-bg jarallax" 
            style={{
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="cta-content text-center">
                                <div class="section-title white-title mb-35">
                                    <h2 class="title">Need Fast & Secure Broadband?</h2>
                                </div>
                                <div class="cta-btn-wrap">
                                    <a href="airtel.html" class="btn">View our Plans</a>
                                    <span class="or">OR</span>
                                    <a href="tel:+917904856728" class="btn transparent-btn">7904856728</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-0 order-lg-2">
                            <div class="progress-video">
                                <img src={progress_img} alt="Best Broadband Connection in Chennai" title="Best Broadband Plans in Chennai"/>
